export const t = {
  en: {
    ...
    newPos: (portfolio, top) => `🆕 *New position · ${portfolio} Portfolio · Top ${top}*`,
    movedUp: (portfolio, top) => `📈 *Entered Top ${top} · ${portfolio} Portfolio*`,
  ...
  ru: {
    ...
    newPos: (portfolio, top) => `🆕 *Новая позиция · Портфель ${portfolio} · Топ ${top}*`,
    movedUp: (portfolio, top) => `📈 *Вошла в Топ ${top} · Портфель ${portfolio}*`,
